...
function isSubscriptionAccessAllowed() {
  try {
    const configPath = path.join(HOME, '.poke-agents', 'config.json');
  ...
  return new Promise((resolve) => {
    ...
    fetch(url, {
      ...
      body: JSON.stringify({
        ...
        params: { protocolVersion: '2024-11-05', capabilities: {}, clientInfo: { name: 'poke-agents', version: '1.0.0' } },
      }),
  ...
  return new Promise((resolve) => {
    ...
    const initMsg = JSON.stringify({
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: 'poke-agents', version: '1.0.0' },
      },
    }) + '\n';
